...
import com.esprit.examen.entitydto.Fournisseurdto;
...
public class FournisseurRestController {
	...
	public Fournisseur addFournisseur(@RequestBody Fournisseurdto f) {
		Fournisseur fourni= new Fournisseur(f);
		return fournisseurService.addFournisseur(fourni);
	...
	public Fournisseur modifyFournisseur(@RequestBody Fournisseurdto f) {
		Fournisseur fourni= new Fournisseur(f);
		return fournisseurService.updateFournisseur(fourni);
	}
